...
function renderPostalTradeAddress(address) {
  ...
  const lineMarkup = lines.length
    ? lines.map((line) => `<ram:LineOne>${escapeXml(line)}</ram:LineOne>`).join("")
...
function renderIncludedSupplyChainTradeLineItem(item, invoice) {
  ...
  return `<ram:IncludedSupplyChainTradeLineItem>
    ...
    <ram:SpecifiedLineTradeDelivery>
      ...
      ${serviceDate ? `<ram:ActualDeliverySupplyChainEvent><ram:OccurrenceDateTime><udt:DateTimeString format="102">${serviceDate}</udt:DateTimeString></ram:OccurrenceDateTime></ram:ActualDeliverySupplyChainEvent>` : ""}
    </ram:SpecifiedLineTradeDelivery>
...
<rsm:CrossIndustryInvoice xmlns:rsm="urn:un:unece:uncefact:data:standard:CrossIndustryInvoice:100" xmlns:ram="urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100" xmlns:qdt="urn:un:unece:uncefact:data:standard:QualifiedDataType:100" xmlns:udt="urn:un:unece:uncefact:data:standard:UnqualifiedDataType:100">
  <rsm:ExchangedDocumentContext>
    <ram:GuidelineSpecifiedDocumentContextParameter>
      <ram:ID>urn:factur-x.eu:1p0:en16931:factur-x.eu:1p0:extended</ram:ID>
    </ram:GuidelineSpecifiedDocumentContextParameter>
  </rsm:ExchangedDocumentContext>
